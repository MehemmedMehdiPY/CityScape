...
The source code was taken from the below repository:
    https://github.com/CoinCheung/BiSeNet/blob/master/lib/models/resnet.py
"""
...
class Resnet18(nn.Module):
    def __init__(self, pretrained: bool = False, extractor_path: str = None):
        ...
        if self.pretrained:
            if extractor_path is None:
                raise Exception('extractor_path cannot be None if pretrained is True')
            # ../saved_models/resnet18-5c106cde.pth'
    ...
    def init_weight(self):
        # state_dict = modelzoo.load_url(resnet18_url, model_dir='../saved_models/')
        if self.pretrained:
            state_dict = torch.load(self.extractor_path)
